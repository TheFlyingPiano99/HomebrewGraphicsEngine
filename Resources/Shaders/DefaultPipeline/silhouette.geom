...
void main () {
	vec4 a = gl_Position = gl_in[0].gl_Position;
	vec4 b = gl_Position = gl_in[1].gl_Position;
	vec4 c = gl_Position = gl_in[2].gl_Position;
	vec3 n = normalize(cross((b - a).xyz, (a - c).xyz));
