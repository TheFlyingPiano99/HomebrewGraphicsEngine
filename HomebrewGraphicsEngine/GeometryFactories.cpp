...
namespace hograengine {
	...
	Geometry* GeometryFactory::WireframeCube::getInstance()
	{
		if (geometry == nullptr) {
			geometry = create();
		}
	...
	void GeometryFactory::WireframeCube::destroyInstance()
	{
		if (geometry != nullptr) {
			delete geometry;
		}
	...
	Geometry* GeometryFactory::WireframeCube::geometry = nullptr;
	Geometry* GeometryFactory::WireframeCube::create()
	{
		std::vector<Vertex> vertices;
